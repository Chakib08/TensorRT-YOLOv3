...
def get_engine(onnx_file_path, input_shape, input_res, calib_cache, engine_file_path=""):
    ...
    def build_engine():
        ...
        with trt.Builder(TRT_LOGGER) as builder, builder.create_network(
                common.EXPLICIT_BATCH) as network, builder.create_builder_config() as config, trt.OnnxParser(network,TRT_LOGGER) as parser, trt.Runtime( TRT_LOGGER) as runtime:
            config.max_workspace_size = 2048  # 256MiB
            ...
            if args.precision == "INT8":
                ...
                config.int8_calibrator = YOLOEntropyCalibrator('calib_images', input_res, calib_cache)
            # Parse model file
